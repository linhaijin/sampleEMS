...
namespace EquipmentMS.BaseClass
{
    class DataBase:IDisposable
    {
        ...
        private void Open()
        {
            ...
            if (con == null)
            {
            	string str = ConfigurationManager.AppSettings["dbconn"];
            	con = new SqlConnection(str);
                //con = new SqlConnection(@"Initial Catalog='db_EquipmentMS';Server='192.168.0.200,1433';User ID='sa';Password='egps2009@gis_5488';Persist Security Info=True");
            }
